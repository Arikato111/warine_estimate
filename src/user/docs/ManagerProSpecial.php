...
function ManagerProSpecial () {
    ...
    $input_component_1 = $form_input_component([
        ["title"=> '1.1 การวางแผนพัฒนามาตรฐานการเรียนรู้ของผู้เรียน', "name"=>''],
        ["title"=> '1.2 การจัดทำและพัฒนาหลักสูตรสถานศึกษา', "name"=>''],
        ["title"=> '1.3 การพัฒนากระบวนการจัดการเรียนรู้ที่เน้นผู้เรียนเป็นสำคัญและปฏิบัติการสอน', "name"=>''],
        ["title"=> '1.4 การส่งเสริม สนับสนุน การพัฒนาหรือการนำสื่อนวิตกรรม และเทดโนโลยีทางการศึกษามาใช้ในการจัดการเรียนรู้', "name"=>''],
        ["title"=> '1.5 การนิเทศ กำกับ ติดตาม ประเมินผลการจัดการเรียนรู้ของครูในสถานศึกษา และมีการประกันคุณภาพการศึกษาภายในสถานศึกษา', "name"=>''],
        ["title"=> '1.6 การศึกษา วิเคราะห์ เพื่อแก้ปัญหา และพัฒนาการจัดการเรียนรู้ เพื่อยกระดับคุณภาพการศึกษาของสถานศึกษา', "name"=>''],
        ["title"=> '2.1 การบริหารจัดการ สถานศึกษาให้เป็นไปตามกฎหมาย ระเบียบ ข้อบังคับ นโยบาย และตามหลักบริหารกิจการบ้านเมื้องที่ดี', "name"=>''],
        ["title"=> '2.2 การบริหารกิจการผู้เรียนและการส่งเสริมพัฒนาผู้เรียน', "name"=>''],
        ["title"=> '2.3 การจัดระบบดูแลช่วยเหลือผู้เรียน', "name"=>''],
        ["title"=> '3.1 การสร้่างและพัฒนาเครือข่ายเพื่อพัฒนาสถานศึกษา', "name"=>''],
        ["title"=> '3.2 การบริหารการเปลี่ยนแปลงและนวัฒกรรมในสถานศึกษาเพื่อพัฒนาสถานศึกษา', "name"=>''],
        ["title"=> '4.1 การสร้างและพัฒนาเครือข่ายเพื่อพัฒนาการเรียนรู้', "name"=>''],
        ["title"=> '4.2 การจัดระบบการให้บริการในสถานศึกษา', "name"=>''],
        ["title"=> '1 การพัฒนาตนเองและวิชาชีพ', "name"=>''],
        ["title"=> '2 การนำความรู้ ทักษะ ที่ได้จากการพัฒนาตนเองและวิชาชีพมาใช้ในการพัฒนาการบริหารจัดการสถานศึกษาที่ส่งผลต่อคุณภาพผู้เรียน ครู และสถานศึกษา', "name"=>''],
    ]);
    ...
    return title('ผู้บริหาร ชำนาญการพิเศษ') . 
    <<<HTML
        <form action="/manager-pro" method="post">
        <div class="content">
            <div class="head">
                <div class="head-title">แบบประเมินผลการปฏิบัติงานของข้าราชการครูและบุคลากรทางการศึกษา</div>
                <div class="head-title">ตำแหน่งผู้บริหารสถานศึกษา วิทยฐานะชำนาญการพิเศษ</div>
                <div>( ทุกสังกัด )</div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="m-l-3 t-c t-3 p-3">
                ...
                <div>ตำแหน่งผู้บริหารสถานศึกษา วิทยฐานะชำนาญการพิเศษ</div>
            </div>
        </div>
